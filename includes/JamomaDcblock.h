...
namespace Jamoma {
	...
	/**	This AudioObject removes DC offset (sometimes called <a href="https://en.wikipedia.org/wiki/DC_bias">DC bias</a> from a Sample or SampleBundle.
	 ...
	 @details This first-order highpass filter algorithm is used pretty much everywhere (STK, ChucK, RTCMix, SuperCollider, Max, Pd, etc),
	...
	public:
		...
		/**	Resets the DC-Blocking filter.
		 @details This algorithm uses an IIR filter, meaning that it relies on feedback.  If the filter should
