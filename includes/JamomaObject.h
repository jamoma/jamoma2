 ...
 *
 * @details Parent class for all Objects with the Jamoma library. Defines common features such as Parameters and Messages that are used by all Objects throughout the codebase.
 *
